...
const AboutMe = () => {
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "auto", textAlign: "center" }}>
      ...
      <ul style={{ listStyleType: "none", padding: "0", fontSize: "18px", lineHeight: "1.8" }}>
        <li>📱 <strong>Electronics</strong>: Smartphones, Laptops, Tablets, Smartwatches, Headphones, and more.</li>
        <li>👗 <strong>Fashion & Apparel</strong>: Men's & Women's Clothing, Shoes, Accessories, and Designer Wear.</li>
      ...
      <p style={{ fontSize: "18px", lineHeight: "1.6", marginTop: "20px" }}>
        At <strong>E-Shop</strong>, we ensure quality, affordability, and fast delivery.  
        Enjoy secure payment options and excellent customer service while shopping with us.  
